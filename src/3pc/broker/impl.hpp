...
#ifndef CBDC_UNIVERSE0_SRC_3PC_BROKER_IMPL_H_
#define CBDC_UNIVERSE0_SRC_3PC_BROKER_IMPL_H_
    ...
    class impl : public interface {
      ...
      private:
        ...
        void handle_prepare(
            ...
            uint64_t shard_idx,
            threepc::runtime_locking_shard::interface::prepare_return_type
                res);
        ...
        void handle_rollback(
            ...
            ticket_number_type ticket_number,
            uint64_t shard_idx,
            threepc::runtime_locking_shard::interface::rollback_return_type
                res);
        ...
        void handle_find_key(
            ...
            std::optional<
                threepc::directory::interface::key_location_return_type> res);
        ...
        void handle_get_tickets(const recover_callback_type& result_callback,
                                uint64_t shard_idx,
                                const threepc::runtime_locking_shard::
